...
module.exports = {
  ...
  "module": {
    "rules": [
      ...
      {
        "exclude": [
          path.join(process.cwd(), "src/styles/base/_variables.scss"),
          path.join(process.cwd(), "src/styles/helpers/_mixins.scss"),
          ...
          path.join(process.cwd(), "node_modules/hamburgers/dist/hamburgers.min.css"),
  ...
  "plugins": [
    ...
    new GlobCopyWebpackPlugin({
      ...
      "globOptions": {
        "cwd": "/Users/vbezruch/Documents/Work/ITA/ita-cloud-lv-232/src",
        "dot": true,
        "ignore": "**/.gitkeep"
      }
    }),
